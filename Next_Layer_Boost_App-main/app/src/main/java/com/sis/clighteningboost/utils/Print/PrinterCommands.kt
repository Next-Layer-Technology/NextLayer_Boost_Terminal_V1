package com.sis.clighteningboost.utils.Print
...
object PrinterCommands {
    ...
    @JvmField
    val reset = byteArrayOf(0x1b, 0x40) //Reset printer
    @JvmField
    val print = byteArrayOf(0x0a) //Print and wrap
    @JvmField
    val INIT = byteArrayOf(27, 64)
    @JvmField
    var FEED_LINE = byteArrayOf(10)
    var SELECT_FONT_A = byteArrayOf(27, 33, 0)
    var FONT_B = byteArrayOf(0x1B, 0x4D, 0x01)
    var ALLINEA_SX = byteArrayOf(0x1B, 0x61, 0x00)
    var ALLINEA_CT = byteArrayOf(0x1B, 0x61, 0x01)
    var ALLINEA_DX = byteArrayOf(0x1B, 0x61, 0x02)
    var GRASSETTO_ON = byteArrayOf(0x1B, 0x47, 0x11)
    var GRASSETTO_OFF = byteArrayOf(0x1B, 0x47, 0x00)
    var SET_6 = byteArrayOf(0x1B, 0x52, 0x06)
    var CODICI = byteArrayOf(0x1B, 0x74, 0x13)
    var EURO = byteArrayOf(0xD5.toByte())
    var PALLINO = byteArrayOf(0x5B.toByte())
    var FONT_3X = byteArrayOf(0x1D, 0x21, 0x21)
    var FONT_2X = byteArrayOf(0x1D, 0x21, 0x11)
    var FONT_1X = byteArrayOf(0x1D, 0x21, 0x00)
    ...
    var SELECT_BIT_IMAGE_MODE = byteArrayOf(0x1B, 0x2F, 33, 255.toByte(), 3)
    ...
    const val QRCODE_IMAGE_HEIGHT = 255
    const val QRCODE_IMAGE_WIDTH = 255
